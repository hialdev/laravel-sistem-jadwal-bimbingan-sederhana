                    ...
                    <form action="{{ route('jadwal.update',$jadwal->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('mahasiswa_id') is-invalid @enderror"
                                name="mahasiswa_id" value="{{ old('mahasiswa_id',$jadwal->mahasiswa_id) }}" placaeholder="ID Mahasiswa" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('dosen_id') is-invalid @enderror"
                                name="dosen_id" value="{{ old('dosen_id',$jadwal->dosen_id) }}" placaeholder="ID Dosen" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('judul') is-invalid @enderror"
                                name="judul" value="{{ old('judul',$jadwal->judul) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                ...
                                rows="5"
                                required>{{ old('deskripsi',$jadwal->deskripsi) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control @error('awal') is-invalid @enderror"
                                name="awal" value="{{ old('awal',$jadwal->awal) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control @error('akhir') is-invalid @enderror"
                                name="akhir" value="{{ old('akhir',$jadwal->akhir) }}" required>
