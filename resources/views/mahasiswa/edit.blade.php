    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card border-0 shadow rounded mt-3">
                <div class="card-body">
                    <h2>Edit Data Mahasiswa dengan ID {{ $mahasiswa->id }}</h2>
                    <form action="{{ route('mahasiswa.update',$mahasiswa->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="tanggal_lahir" name="tanggal_lahir" class="form-control" value="{{ old('tanggal_lahir', $mahasiswa->tanggal_lahir ) }}"required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('tahun_masuk') is-invalid @enderror"
                                name="tahun_masuk" value="{{ old('tahun_masuk',$mahasiswa->tahun_masuk) }}" required>
